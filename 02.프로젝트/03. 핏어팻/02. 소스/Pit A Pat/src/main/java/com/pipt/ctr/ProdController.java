...
public class ProdController {
	...
	@Autowired
	ProdService prodsService;

	// 제품 목록 조회
	@RequestMapping("/piptProdInqy1010.do")
	public String piptProdInqy1010(Model model, HashMap<String, Object> paramMap) throws Exception {
		//
		try {
			//--------------------------------------------------------------------------------------------
			// 제품 목록 조회
			//--------------------------------------------------------------------------------------------
			prodsService.piptProdInqy1010(model, paramMap);
			
		} catch (Exception e) {
			//
			logger.debug("Exception : 제품 목록 조회 중 에러가 발생했습니다. (" + e.getMessage() + ")");
		}
		//
		return Path.PROD_PATH + "pipt_prod_inqy_1010.jsp";
	}
 ...
 * }
 * 
 * @RequestMapping("/piptFaveInqy1010.do") public String cart(Model model) { HttpSession
 ...
 * 
 * return "redirect:piptFaveInqy1010.do?g_num=" + g_num + "&count=" + count + "&m_num=" +
 * m_num;
 * 
 * }
 * 
 ...
 * 
 * return "redirect:piptFaveInqy1010.do?idx=" + idx;
 * 
 * }
 */
	}
 ...
 * 
 * String pageMenu = Paging.getPaging("tree/piptProdInqy1010.do", nowPage, row_total,
