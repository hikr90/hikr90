...
<script>
	...
	function orderAction() {
		...
		var oi_deaddr = f.dezipcode.value + ' ' + f.deaddr.value + ' '
				+ f.deaddress.value;
...
<div id="wrap">
	...
	<div id="product">
		<form id="producttable" name="ff" method="POST" action="import2.do">
			<h2>주문 상품</h2>
			<p>&nbsp;</p>
			<table width="1200" height="251" border="0" cellpadding="10"
				cellspacing="0">
				<%-- 				<input type="hidden" name="oi_price" value="${vo.g_price}"> --%>
				<%-- 				<input type="hidden" name="oi_count" value="${vo.count}"> --%>
				...
				<tbody>
					...
					<c:forEach var="vo" items="${ list }">
						...
						<tr>
							...
							<td>${vo.count }그루</td>
							<td><fmt:formatNumber value="${vo.g_price * vo.count }" />
								원</td>
						</tr>
					</c:forEach>
					<tr>
						...
						<td height="50" colspan="2"><span class="productTotal">상품금액
								+ 배송비(3000원)</span></td>
						<td height="50" colspan="2"><fmt:formatNumber
								value="${sum+3000 }" />원</td>
					</tr>
				</tbody>
			</table>
			...
			<table id="orderform" width="1120" height="240" border="0"
				...
				<tbody>
					<tr>
						...
						<td width="283">${vo.m_name }</td>
						<th width="182" scope="row">이메일</th>
						<td width="319">${vo.m_email }
							<p>
					...
					<tr>
						...
						<td colspan="3"><input type="radio" id="smsY" name="oi_sms"
							value="1" checked> 주문 배송 정보 수신&nbsp;&nbsp; <input
							type="radio" id="smsN" name="oi_sms" value="2"> 수신받지않음</td>
			...
			<table id="deliveryform" width="1120" height="320" border="0"
				...
				<tbody>
					<tr>
						<th width="182" height="80" scope="row">이름</th>
						<td width="283"><input type="text" name="oi_dename" id="name">
						</td>
						<th width="182" scope="row">이메일</th>
						<td width="319">
							<p>
					...
					<tr>
						<th width="182" height="80" scope="row">휴대폰번호</th>
						<td><input id="hp1" name="dehp1" size="4"> - <input
							id="hp2" name="dehp2" size="4"> - <input id="hp3"
							name="dehp3" size="4"></td>
						<th width="182" scope="row">전화번호</th>
						<td><input type="text" id="tel1" name="detel1" size="4">
							- <input type="text" id="tel2" name="detel2" size="4"> -
							<input type="text" id="tel3" name="detel3" size="4"></td>
					</tr>
					<tr>
						<th width="182" height="80" scope="row">주소</th>
						<td colspan="3"><input id="zipcode" name="dezipcode">
							<img
							src="${pageContext.request.contextPath}/resources/image/postaddress.png"
							value="우편번호찾기" onclick="javascript:goPopup();"><br> <input
							id="addr" name="deaddr" size="35"> <input id="address"
							name="deaddress" size="40"> <span class="sub">상세
								주소 입력</span></td>
					</tr>
					<tr>
			...
			<div align="center">
				...
				<table id="totalform" width="400" height="240" border="0"
					cellpadding="10" cellspacing="0">
					<input type="hidden" name="oi_price" value="${sum}">

					<tbody>
						<tr>
							<th width="143" height="80" scope="row">주문금액</th>
							<td width="257"><fmt:formatNumber value="${sum }" />원</td>
						<tr>
							<th width="143" height="80" scope="row">배송비</th>
							<td><fmt:formatNumber value="3000" />원</td>
						<tr>
							<th width="143" height="80" scope="row">총 주문금액</th>
							<td colspan="3"><fmt:formatNumber value="${sum+3000 }" />원</td>
			...
			<div align="center">
				...
				<p>
					<span class="payimg"> <img
						src="${pageContext.request.contextPath}/resources/image/pay.png"
						alt="" onclick="javascript:orderAction();" /></span>
				</p>
			</div>
		</form>
