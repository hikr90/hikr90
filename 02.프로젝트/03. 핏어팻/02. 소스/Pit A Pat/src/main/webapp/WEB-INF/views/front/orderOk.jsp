...
<div id="wrap">
	...
	<div id="product">
		<form id="producttable">
			...
			<p>
				<span class="orderimg">
					<img src="${pageContext.request.contextPath}/resources/image/checkorder.png" alt="" onclick="location.href='piptMypageInqy1010.do'"/>&nbsp;&nbsp;&nbsp;&nbsp;
					<img src="${pageContext.request.contextPath}/resources/image/keep.png" alt="" onclick="location.href='piptProdInqy1010.do'"/></span>
			</p>
		</form>
	</div>
