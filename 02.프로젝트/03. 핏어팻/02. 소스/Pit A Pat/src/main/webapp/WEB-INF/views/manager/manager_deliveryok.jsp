...
<link
	href="${pageContext.request.contextPath}/resources/css/manage_deliveryok.css"
		...
		<div id="main">
			<div id="delivery">
				...
				<div class="deli1" style="cursor: pointer;"
					...
					<div class="title">
						<a href="manager_payok.do">입금완료</a>
					</div>
				...
				<div class="deli4" style="cursor: pointer;"
					...
					<div class="pic1">
						<a href="manager_deliveryok.do"><img
							src="${pageContext.request.contextPath}/resources/image/delivery4_1.png"
							width="80" height="80" alt="" /></a>
					</div>
					<div class="title1">
			...
			<div id="productlist">
				...
				<form id="listform">
					<table border="0" cellspacing="0"
						...
						<tbody>
							<tr>
								<th scope="row" width="92" height="65">No</th>
								<th width="157">주문일</th>
								<th width="182">송장번호</th>
								<th width="312">상품명</th>
								<th width="122">주문자</th>
								<th width="122">수량</th>
								<th width="441">주소</th>
							...
							<tr>
								<td scope="row" width="92" height="75">&nbsp;</td>
								<td width="157" height="75">&nbsp;</td>
								<td width="182" height="75">&nbsp;</td>
								<td width="312" height="75">&nbsp;</td>
								<td width="122" height="75">&nbsp;</td>
								<td width="122" height="75">&nbsp;</td>
								<td width="441" height="75">&nbsp;</td>
							</tr>
