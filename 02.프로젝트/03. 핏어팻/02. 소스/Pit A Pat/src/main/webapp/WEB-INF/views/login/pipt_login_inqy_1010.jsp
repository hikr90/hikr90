...
<body>
	<div id="wrap">
		...
		<div id="form">
			<form method="POST" action="piptLoginInqy1011.do" name="ff">
				<center>
		...
		<div id="search">
			<div class="searchid">
				<a href="#"
					onClick="MM_openBrWindow('piptLoginInqy1030.do','','width=520,height=420')">아이디찾기
				</a>
			</div>
			<div class="searchpw">
				<a href="#"
					onClick="MM_openBrWindow('piptLoginInqy1040.do','','width=520,height=420')"
