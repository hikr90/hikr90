...
public interface MtgService {
	...
	void intrMtgInqy1091(Model model, HashMap<String, Object> paramMap) throws Exception; // 회의 중복 조회
	
	void intrMtgInqy2010(Model model, HashMap<String, Object> paramMap) throws Exception;	// 캘린더 조회
	void intrMtgInqy2020(Model model, HashMap<String, Object> paramMap) throws Exception;	// 캘린더 목록 조회
