...
public class AprvDao {
	...
	// 결재선 시퀀스 조회
	public HashMap<String, Object> intrAprvInqy2010(Model model, HashMap<String, Object> paramMap) {
		//
		HashMap<String, Object> defaultInfo = null;
	...
	// 다음 결재 조회
	public HashMap<String, Object> intrAprvInqy2012(Model model, HashMap<String, Object> paramMap) {
		//
		HashMap<String, Object> defaultInfo = null;
	...
	// 결재선 관리 조회
	public List<HashMap<String, Object>> intrAprvInqy4011(Model model, HashMap<String, Object> paramMap) {
		//
		List<HashMap<String, Object>> defaultList = null;
	...
	// 결재선 상세 조회
	public List<HashMap<String, Object>> intrAprvInqy4031(Model model, HashMap<String, Object> paramMap) {
		//
		List<HashMap<String, Object>> defaultList = null;
	...
	// 결재 타입 조회
	public List<HashMap<String, Object>> intrAprvInqy4032(Model model, HashMap<String, Object> paramMap) {
		//
		List<HashMap<String, Object>> defaultList = null;
	...
	// 결재 마스터 등록 (APRV_MAST)
	public int intrAprvProc1011(Model model, HashMap<String, Object> paramMap) {
		//
		int resInt = 0;
	...
	// 결재 이력 등록 (APRV_HIST)
	public int intrAprvProc1012(Model model, HashMap<String, Object> paramMap) {
		//
		int resInt = 0;
	...
	public int intrAprvProc1013(Model model, HashMap<String, Object> paramMap) {
		//
		int resInt = 0;
	...
	public int intrAprvProc1014(Model model, HashMap<String, Object> paramMap) {
		//
		int resInt = 0;
	...
	public int intrAprvProc1015(Model model, HashMap<String, Object> paramMap) {
		//
		int resInt = 0;
	...
	public int intrAprvProc1016(Model model, HashMap<String, Object> paramMap) {
		//
		int resInt = 0;
	...
	public int intrAprvProc1017(Model model, HashMap<String, Object> paramMap) {
		//
		int resInt = 0;
	...
	// 결재 단계 수정
	public int intrAprvProc2011(Model model, HashMap<String, Object> paramMap) {
		//
		int resInt = 0;
	...
	// 결재 처리 유형 수정
	public int intrAprvProc2012(Model model, HashMap<String, Object> paramMap) {
		//
		int resInt = 0;
	...
	// 결재 일련번호 수정
	public int intrAprvProc2013(Model model, HashMap<String, Object> paramMap) {
		//
		int resInt = 0;
	...
	// 결재선 마스터 등록
	public int intrAprvProc4011(Model model, HashMap<String, Object> paramMap) {
		//
		int resInt = 0;
	...
	// 결재선 상세 등록
	public int intrAprvProc4012(Model model, HashMap<String, Object> paramMap) {
		//
		int resInt = 0;
	...
	// 결재선 마스터 수정
	public int intrAprvProc4013(Model model, HashMap<String, Object> paramMap) {
		//
		int resInt = 0;
	...
	// 결재선 마스터 삭제
	public int intrAprvProc4014(Model model, HashMap<String, Object> paramMap) {
		//
		int resInt = 0;
	...
	// 결재선 상세 삭제
	public int intrAprvProc4015(Model model, HashMap<String, Object> paramMap) {
		//
		int resInt = 0;
