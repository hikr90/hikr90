							...
							<div class="post_wrap">
								...
								<div class="post_view">
									<dl>
										...
										<dt>&#10003; 회의일자</dt>
										<dd>
											<input type="text" class="srch_cdt_date srchSdt" id="mtgDt" name="mtgDt" value="${fn:substring(defaultInfo.mtgDt, 0, 4)}-${fn:substring(defaultInfo.mtgDt, 4, 6)}-${fn:substring(defaultInfo.mtgDt, 6, 8)}" readonly="readonly" />
										</dd>
									</dl>
									<dl class="post_info">
										<dt>회의자료</dt>
										...
										<dt>&#10003; 회의시간</dt>
										<dd>
											<input type="text" id="timeSt" class="srchSdt time_picker" name="mtgStm" value="${defaultInfo.mtgStm}" readonly="readonly" />
											~
											<input type="text" id="timeEd" class="srchSdt time_picker" name="mtgEtm" value="${defaultInfo.mtgEtm}" readonly="readonly" />
									</dl>
										</dd>
									<dl class="post_info">
										<dt></dt>
