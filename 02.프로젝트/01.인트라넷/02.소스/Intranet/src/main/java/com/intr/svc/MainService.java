...
public interface MainService {
	...
	void intrMainInqyService1050(Model model, HashMap<String, Object> paramMap) throws Exception;		// 페이징 처리
	void intrMainInqyService1060(Model model, HashMap<String, Object> paramMap) throws Exception;		// 검색 값 저장
	//
