...
public interface View {
	...
	// 쿼리
	//--------------------------------------------------------------------------------------------
	public static final String INTR_QUERY_DETL_1010 = "intr_query_detl_1010.jsp";	// 쿼리 입력 화면
	public static final String INTR_QUERY_DETL_1011 = "intr_query_detl_1011.jsp";		// 쿼리 결과 화면
	
	//--------------------------------------------------------------------------------------------
	// 프로젝트
	//--------------------------------------------------------------------------------------------
	public static final String INTR_PROJ_LIST_1010 = "intr_proj_list_1010.jsp"; 		// 프로젝트 목록
	public static final String INTR_PROJ_DETL_1010 = "intr_proj_detl_1010.jsp"	;	// 프로젝트 상세 화면
	public static final String INTR_PROJ_DETL_1020 = "intr_proj_detl_1020.jsp"	;	// 프로젝트 등록 화면
	public static final String INTR_PROJ_DETL_1030 = "intr_proj_detl_1030.jsp";		// 프로젝트 수정 화면
}
