...
public interface EmpService {
	...
	void intrEmpInqy1020(Model model, HashMap<String, Object> paramMap) throws Exception; 	// 목록 건수 조회 
	void intrEmpInqy1030(Model model, HashMap<String, Object> paramMap) throws Exception;	// 상세 조회
	String intrEmpInqy1040(Model model, HashMap<String, Object> paramMap) throws Exception; // 사원 아이디 중복 조회
	
	// 부서 직급
	void intrEmpInqy1050(Model model, HashMap<String, Object> paramMap) throws Exception; 	// 부서, 직급 조회
	void intrEmpInqy1060(Model model) throws Exception; 									// 부서 사원 트리 조회
	void intrEmpInqy1070(Model model, HashMap<String, Object> paramMap) throws Exception; 	// 부서 사원 수 조회
