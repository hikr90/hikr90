...
public interface EmpService {
	...
	void intrEmpInqyService1020(Model model, HashMap<String, Object> paramMap) throws Exception; 	// 목록 건수 조회 
	...
	void intrEmpInqyService1070(Model model, HashMap<String, Object> paramMap) throws Exception; 	// 부서 사원 수 조회
