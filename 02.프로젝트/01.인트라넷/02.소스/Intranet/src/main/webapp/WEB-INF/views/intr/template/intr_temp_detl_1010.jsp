...
<div class="post_write" style="margin-top: 0px;">
	<dl>
		...
		<dd>
			<input type="text" id="templateNm" title="양식명" name="templateNm" value="${defaultInfo.templateNm}">
	...
	<dl>
		...
		<dd>
			<textarea id="editor" name="templateCont" title="양식 내용">${defaultInfo.templateCont}</textarea>
		</dd>
	</dl>
</div>
