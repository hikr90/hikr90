...
<div id="qna">
    ...
    <tr>
      ...
      <td width="577">
        ...
        <p><a href="change_faq.do?idx=${vo.idx}&ctg=${ctg}" class="blind_view<%=i%>">${vo.question}</a></p>
        </div>
      </td>
      
      <td width="120"><a href="change_faq.do?idx=${vo.idx}&ctg=${ctg}"><img src="${pageContext.request.contextPath}/resources/image/changeboard.png"  alt=""/></a></td>
