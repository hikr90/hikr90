...
<link
	href="${pageContext.request.contextPath}/resources/css/manage_payok.css"
		...
		<div id="main">
			<div id="delivery">
				...
				<div class="deli1" style="cursor: pointer;"
					...
					<div class="pic1">
						<a href="manager_payok.do"><img
							src="${pageContext.request.contextPath}/resources/image/delivery1_1.png"
				...
				<div class="deli2" style="cursor: pointer;"
					onclick="location.href='manager_prepare.do';">
					<div class="pic">
						<a href="manager_prepare.do"><img
							src="${pageContext.request.contextPath}/resources/image/delivery2_2.png"
				...
				<form id="searchform">
					<table border="0" cellspacing="0"
						...
						<tbody>
							...
							<tr>
								<th scope="row" height="60">결제방식</th>
								<td><input type="radio" name="radio1" id="radio6"
									value="radio" checked> 전체 &nbsp;&nbsp;&nbsp; <input
									type="radio" name="radio1" id="radio7" value="radio">
									신용카드 &nbsp;&nbsp;&nbsp; <input type="radio" name="radio1"
									id="radio8" value="radio2"> 무통장 &nbsp;&nbsp;&nbsp; <input
									type="radio" name="radio1" id="radio9" value="radio3">
									핸드폰결제</td>
							</tr>
			...
			<div id="productlist">
				...
				<form id="listform">
					<table border="0" cellspacing="0"
						...
						<tbody>
							<tr>
								<th scope="row" width="93" height="65">No</th>
								<th width="152">주문일</th>
								<th width="152">주문번호</th>
								<th width="364">상품명</th>
								<th width="129">주문자</th>
								<th width="129">입금액</th>
								<th width="129">수량</th>
								<th width="148">입금방식</th>
								<th width="132">배송준비</th>
							</tr>
							<tr>
								<td scope="row" width="93" height="75">&nbsp;</td>
								<td width="152" height="75">&nbsp;</td>
								<td width="152" height="75">&nbsp;</td>
								<td width="364" height="75">&nbsp;</td>
								<td width="129" height="75">&nbsp;</td>
								<td width="129" height="75">&nbsp;</td>
								<td width="129" height="75">&nbsp;</td>
								<td width="148" height="75">&nbsp;</td>
								<td width="132" height="75"><img
									src="${pageContext.request.contextPath}/resources/image/prepare.png"
