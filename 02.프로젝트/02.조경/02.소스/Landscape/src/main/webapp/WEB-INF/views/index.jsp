...
<%@include file="/WEB-INF/views/include/head_comm_html.jsp"%>
...
<body>
	...
	<article id="slideShow">
		<div id="slideShowBox">
			<div id="slidePanel">
				<img src="${pageContext.request.contextPath}/resources/image/baner1.png" class="slideImg" />
				<img src="${pageContext.request.contextPath}/resources/image/baner1-1.png" class="slideImg" />
				<img src="${pageContext.request.contextPath}/resources/image/baner1.png" class="slideImg" />
				<img src="${pageContext.request.contextPath}/resources/image/baner1-1.png" class="slideImg" />
			</div>
		</div>
		...
		<div id="topMenuBox">
			<c:choose>
				<c:when test="${empty sessionScope.member}">
					...
					<a href="cs_form.do" 		target=_parent>고객센터</a>
				</c:when>
				<c:otherwise>
					${user.m_name }&nbsp;&nbsp;|&nbsp; 
					<a href="index.do" target=_parent>Home</a>&nbsp;&nbsp;|&nbsp; 
