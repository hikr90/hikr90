...
public class ManagerOrderDAO {
	...
	public List<OrderInfoVO> manager_order(HashMap<String, Integer> map) {
		...
		List<OrderInfoVO> list = sqlSession.selectList("manager_order.manager_orderList", map);
	...
	public HashMap<String, Integer> order_count() {
		...
		int total = sqlSession.selectOne("manager_order.getCount_total");
		int refund = sqlSession.selectOne("manager_order.getCount_refund");
		int change = sqlSession.selectOne("manager_order.getCount_change");
	...
	public List<OrderInfoVO> manager_refund(HashMap<String, Integer> map) {
		...
		List<OrderInfoVO> list = sqlSession.selectList("manager_order.manager_refund", map);
	...
	public List<OrderInfoVO> manager_refund_search(HashMap<String, Object> map) {
		List<OrderInfoVO> list = sqlSession.selectList("manager_order.manager_refund_search", map);
	...
	public int getRowTotal_search(HashMap<String, Object> map) {
		...
		System.out.println("COUNT : " + sqlSession.selectOne("manager_order.getRowTotal_search", map));
