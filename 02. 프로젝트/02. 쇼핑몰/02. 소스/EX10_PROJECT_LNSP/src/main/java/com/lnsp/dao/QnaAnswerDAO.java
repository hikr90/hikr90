...
public class QnaAnswerDAO {
	...
	public int qnaOneAnswerTotal() {
		int res = sqlSession.selectOne("qnaAnswer.qnaOneAnswerTotal");
		return res;
	}
	
	public int qnaOneAnswerPartTotal( int count ) {
		int res = sqlSession.selectOne("qnaAnswer.qnaOneAnswerPartTotal", count);
		return res;
	}
	
	
	public int qnaOneAnswerWaitTotal( int count ) {
		int res = sqlSession.selectOne("qnaAnswer.qnaOneAnswerWaitTotal", count);
		return res;
	}
	
	
	public int qnaOneAnswerCompleteTotal( int count ) {
		int res = sqlSession.selectOne("qnaAnswer.qnaOneAnswerCompleteTotal", count);
		return res;
	}
	
	public int qnaOneAnswerDeleteTotal( int count ) {
		int res = sqlSession.selectOne("qnaAnswer.qnaOneAnswerDeleteTotal", count);
		return res;
	}
	...
	public Map qnaOneAnswerCount() {
		...
		for (int i = 0; i < cnt.length; i++) {
			countmap.put(cnt[i] ,sqlSession.selectOne("qnaAnswer.qnaOneAnswerCount"+(i+1) ) );
		}
		
		countmap.put("wait", sqlSession.selectOne("qnaAnswer.qnaoneAnswerWait"));
		countmap.put("Complete", sqlSession.selectOne("qnaAnswer.qnaoneAnswerComplete"));
	...
	public Map qnaOneAnswerPartCount( int count ) {
		...
		countmap.put("wait", sqlSession.selectOne("qnaAnswer.qnaoneAnswerPartWait", count));
		countmap.put("Complete", sqlSession.selectOne("qnaAnswer.qnaoneAnswerPartComplete", count));
		countmap.put("delete", sqlSession.selectOne("qnaAnswer.qnaoneAnswerPartDelete", count));
	...
	public int qnaProdAnswerTotal() {
		int res = sqlSession.selectOne("qnaAnswer.qnaprodAnswerTotal");
		return res;
	}
	...
	public Map qnaProdAnswerCount() {
		...
		countmap.put("Complete", sqlSession.selectOne("qnaAnswer.qnaprodAnswerComplete"));
