...
public class ManagerGoodsDAO {
	...
	public int delete_goods(int idx, int status, int g_condition) {
		...
		map.put("g_condition", g_condition);
	...
	public List<GoodsVO> Search(HashMap<String, Object> map) {
		List<GoodsVO> search_list = sqlSession.selectList("managergoods.Search", map);
		return search_list;
	}

	public int SearchResult(String text, String radio, int select) {
		HashMap<String, Object> selectmap = new HashMap<String, Object>();
		selectmap.put("search", text);
		selectmap.put("radio", radio);
