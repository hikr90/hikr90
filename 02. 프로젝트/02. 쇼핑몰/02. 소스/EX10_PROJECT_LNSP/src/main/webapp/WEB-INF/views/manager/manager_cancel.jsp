...
<link
	href="${pageContext.request.contextPath}/resources/css/manager_cancel.css"
			...
			<div class="deli1" style="cursor: pointer;"
				...
				<div class="pic">
					<a href="manager_cancel.do"><img
						src="${pageContext.request.contextPath}/resources/image/cancel1_1.png"
				...
				<table border="0" cellspacing="0"
					...
					<tbody>
						...
						<c:if test="${empty list }">
							<tr>
								<td align="center" colspan="10">현재 취소 신청 목록이 비어있습니다.</td>
							</tr>
						</c:if>
						<tr align="center">
