...
<link
	href="${pageContext.request.contextPath}/resources/css/EctGarden.css"
...
<body>
	...
	<div id="objectbanner">
		...
		<img
			src="${pageContext.request.contextPath}/resources/image/insidebanner.png" width="1920" height="300">
		...
		<div id="wrap">
			...
			<div id="content4">
				...
				<div class="ectdoor1">
					<img
						src="${pageContext.request.contextPath}/resources/image/ectdoor1.png"
						alt="" />
				</div>
				<div class="ectdoor2">
					<div class="ectdoor2_1">
						<img
							src="${pageContext.request.contextPath}/resources/image/ectdoor2.png"
							width="560" height="310" alt="" />
					</div>
					<div class="ectdoor3">
						<img
							src="${pageContext.request.contextPath}/resources/image/ectdoor3.png"
							width="560" height="310" alt="" />
					</div>
				</div>
			...
			<div id="content3">
				<div class="ectdoor4">
					<img
						src="${pageContext.request.contextPath}/resources/image/ectdoor4.png"
						alt="" />
				</div>
				...
				<div class="ectdoor5">
					<div class="ectdoor5_1">
						<img
							src="${pageContext.request.contextPath}/resources/image/ectdoor5.png"
							width="360" height="270" alt="" />
					</div>
					<div class="ectdoor6">
						<img
							src="${pageContext.request.contextPath}/resources/image/ectdoor6.png"
							width="360" height="270" alt="" />
					</div>
					<div class="ectdoor7">
						<img
							src="${pageContext.request.contextPath}/resources/image/ectdoor7.png"
							width="360" height="270" alt="" />
					</div>
				</div>
