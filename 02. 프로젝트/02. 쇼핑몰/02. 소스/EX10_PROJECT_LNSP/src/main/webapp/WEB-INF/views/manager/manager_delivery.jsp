...
<link
	href="${pageContext.request.contextPath}/resources/css/manage_delivery.css"
				...
				<div class="deli3" style="cursor: pointer;"
					...
					<div class="pic1">
						<a href="manager_delivery.do"><img
							src="${pageContext.request.contextPath}/resources/image/delivery3_1.png"
							width="80" height="80" alt="" /></a>
					</div>
					<div class="title1">
			...
			<div id="productlist">
				...
				<form id="listform">
					<table border="0" cellspacing="0"
						...
						<tbody>
							<tr>
								<th scope="row" width="94" height="65">No</th>
								<th width="142">주문일</th>
								<th width="142">송장번호</th>
								<th width="292">상품명</th>
								<th width="122">주문자</th>
								<th width="122">수량</th>
								<th width="387">주소</th>
								<th width="127">배송완료</th>
							</tr>
							<tr>
								<td scope="row" width="94" height="75">&nbsp;</td>
								<td width="142" height="75">&nbsp;</td>
								<td width="142" height="75">&nbsp;</td>
								<td width="292" height="75">&nbsp;</td>
								<td width="122" height="75">&nbsp;</td>
								<td width="122" height="75">&nbsp;</td>
								<td width="387" height="75">&nbsp;</td>
								<td width="127" height="75"><img
									src="${pageContext.request.contextPath}/resources/image/deliveryok.png"
