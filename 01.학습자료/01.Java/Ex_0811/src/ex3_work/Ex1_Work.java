...
public class Ex1_Work {
	public static void main(String[] args) {
		// 문제
		// - 과수원에서는 하루 배 5개, 사과 7개, 오렌지 5개가 생산된다.
		// - 과수원에서 하루 생산되는 과일의 총 갯수와 시간당 전체 과일의 평균 생산량을 콘솔에 보여주세요.
		//	- 단, 과일의 갯수와 하루 생산량을 저장할 변수는 int 타입으로, 평균 생산량을 저장할 변수는 float 타입으로 지정해주세요.
		int peer = 5;
		int apple = 7;
		int orange = 5;
